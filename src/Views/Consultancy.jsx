...
function Consultancy() {
  ...
  return (
    ...
    {/* <!--====== Start consultancy Section ======--> */}
               <section class="pt-0 pb-95">
                <div class="consultancy_banner">
                  <img title="consultancy" alt="consultancy" src={require("../image/consultancy_banner.jpg")} />
                    <div class="container">
                    <div class="transparent_txt_banner_wrap">
                        <h1>Consultancy</h1>
                    </div>
                </div>
                </div>
               <div class="container">
                ...
                <div class="grybg_consultancy">
                    <div class="container">
                        <div class="row innerBlock" data-aos="fade-up" data-aos-duration="1000">
                            <div class="">
                            <div class="nomber"><span class="nomber_span">01.</span><div class="tilt"></div></div>
                            <h2 class="block_heading">Marketplaces</h2>
                            ...
                            <h2 class="block_heading">Shopping Cart / Store Management</h2>
                            ...
                            <h2 class="block_heading">End to End Marketplace Solution</h2>
