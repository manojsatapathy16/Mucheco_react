    ...
    $.fn.circursor = function( options ) {
      ...
      return this.each(function() {
        var container = $(this);
          ...
          $(this).append("<div id='circle_cursor' style='position: fixed; z-index: 1000; pointer-events:none; overflow: visible;'><div style='position: absolute; padding:1px;display:flex;align-items:center;justify-content:center; top: -50%; left:-50%; transform: translate(-50%, -50%); -webkit-transform: translate(-50%, -50%); border-radius: 1000px; width: " + options.size1 + "; height: " + options.size1 + "; background-color: rgba(0,0,0,0); border-style: solid; border-width: " + options.width + "; border-color: " + options.color + ";'><div style='height: 3px;width: 3px;background: #3ac0eb;border-radius: 50%;'></div></div></div>");
